...
var App = function () {
    ...
    var handleResponsive = function () {
        ...
        handleSidebarState();			// remove sidebar toggler on phone mode
        handleDesktopTabletContents();	// change desktop mode to tablet mode
        
        handleSidebarAndContentHeight(); // set min-height of .page-content
//        handleContentWidth();
...
//        handleContentWidth();
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
        	...
        	available_height -= 5; // for hidding scroll bar
        	
        	if (body.hasClass('page-sidebar-fixed')) {
            	sider_height = _calculateFixedSidebarViewportHeight();
            } else {
            	sider_height = sidebar.height() + 20;
            }
//        	console.log('available_height: ' + available_height);
//        	console.log('sider_height: ' + sider_height);
//        	console.log('footer_height: ' + $('.footer').outerHeight());
        	
            if (sider_height > available_height)
            	available_height = sider_height;
            
            content.css('min-height', available_height); 
        }          
    };
    
//    var handleContentWidth = function () {
//    	var content = $('.page-content');
//    	var sidebar = $('.page-sidebar');
//    	var available_width;
//    	
//    	if (sidebar.width())
//    		available_width = $(window).width() - sidebar.width();
//    	else
//    		available_width = $(window).width() - sidebarWidth;
//    	
////    	console.log("$(window).width(): " + $(window).width());
////    	console.log("$('.page-sidebar').width(): " + sidebar.width());
////    	console.log("available_width: " + available_width);
//    	content.width(available_width);
//    };
    ...
    var handleSidebarMenu = function () {
        ...
        // handle ajax links
        jQuery('.page-sidebar').on('click', ' li > a.ajaxmenu', function (e) {
                e.preventDefault();
                App.scrollTop();
...
//        	var value = $('.sidebar-search input').val();
//        	$('ul.page-sidebar-menu > li > ul.sub-menu > li').each(function() {
//        		$("a span", this).html().toPinyin();
//        	});
        }
