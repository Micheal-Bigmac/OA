		...
		<table class="table table-striped">
			<div class="row-fluid">
				...
				<s:if test="#request.pid">
					<input name="Submit" class="btn" type="button" 	value="删除所选模块信息" onclick="deleteChose();" />
				</s:if>
			...
			<div class="row-fluid">
				...
				<s:set var="url" value="ModuleAction!moduleList"></s:set>
				...
				<div class="pagination pull-right">
					  <ul>
						...
						<s:if test='(#request.currentIndex) > 1'> 
							<li class="active"><a class="ajaxify" href="ModuleAction!moduleList?index=${requestScope.currentIndex-1}">上页</a></li>
						</s:if>
						<s:else>
						...
						<s:if test='(#request.currentIndex) < #pageCount'> 
							<li class="active"><a class="ajaxify" href="ModuleAction!moduleList?index=${requestScope.currentIndex+1}">下页</a></li>
						</s:if>
						<s:else>
							<li class="disabled"><a href="javascript:;">下页</a></li>
						</s:else>
					 	<li class="active"><a class="ajaxify" href="ModuleAction!moduleList?index=${pageCount }">末页</a></li>
					  </ul>
				</div>
			</div>
		</table>
