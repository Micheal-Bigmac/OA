...
<div class="row-fluid">
	...
	<ul class="breadcrumb">
		<li><i class="icon-home"></i> <a href="index.jsp">主页</a> <i class="icon-angle-right"></i>
		</li>
		<li><a href="#">组织管理</a> <i class="icon-angle-right"></i>
		</li>
		<li><a href="#">人员管理</a>
		</li>
	</ul>
	...
	<form name="formSelect" id="form_Select" method="post" action="FindAction!findByCondition">
		<table>
			<tr>
				...
				<td><input id="className" name="className" type="hidden" value="Person" /> <input id="textfield" name="textfield" type="text" /></td>
					...
					<tbody>
						<s:iterator var="person" value="#request.listObject">
							<tr>
								...
								<td><a class="ajaxify" href="PersonAction!edit?person.id=${person.id }">${person.id }</a>
								</td>
								...
								<td><a class="ajaxify" href="PersonAction!edit?person.id=${person.id }&method=4">编辑</a>&nbsp;|&nbsp; <a class="ajaxify" href="yuangongsalary.html">发工资</a>&nbsp;|&nbsp; <a
									...
									data-action="PersonAction!deletePerson?person.id=${person.id}&method=8|${url}?index=${requestScope.currentIndex}">删除</a>
								</td>
							</tr>
						</s:iterator>
					</tbody>
