...
<div class="row-fluid">
	<form id="fom">
		<table>
			...
			<div class="row-fluid">
				<div class="row-fluid" style="text-align: center; font-size: 20px; background-color: #EEEEEE">付款计划列表</div>
					...
					<tbody>
						<s:iterator var="payPlan" value="#request.listObject">
							<tr>
								...
								<td><a class="ajaxify" href="PayPlanAction!edit?payPlan.id=${payPlan.id}&method=4">编辑(修改)</a> <a class="deleteOne" href="javascript:void(0)"
									data-action="PayPlanAction!deletePayPlan?delid=${payPlan.id }&method=8|${url}">删除</a></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
