			...
			<div class="span6">
				<div class="control-group">
					<div class="controls">
						...
						<option value="name">按用户名字</option>
						<option value="awardUnit">按授予单位</option>
				</select>
...
<div class="row-fluid">
	<form>
		<table>
			<div class="row-fluid">
				<span class="newfont07">选择：</span> <a href="JSP/addDisciplinaryRecords.jsp" class="btn ajaxify">添加奖惩</a>
			</div>
			<div class="row-fluid">
				<div class="row-fluid" style="text-align: center; font-size: 20px; background-color: #EEEEEE">奖惩列表</div>
					...
					<tbody>
						<s:iterator value="#request.listObject" var="dis">
							<tr bgcolor="#FFFFFF">
								...
								<td><a class="ajaxify" href="DisciplinaryRecordsAction!updateDis?disId=${dis.id}&method=4">修改</a>&nbsp; <a class="deleteOne" href="javascript:void(0)"
									data-action="DisciplinaryRecordsAction!deleteDis?disId=${dis.id}&method=8|${url}">删除</a></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
