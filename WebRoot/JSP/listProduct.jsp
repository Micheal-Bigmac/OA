...
<div class="row-fluid">
	<form>
		<table>
			<div class="row-fluid">
				<span >选择：<a
						href="#"  onclick="selectAll();">全选</a>-<a
						href="#"  onclick="unselectAll();">反选</a>
				</span>
			...
			<div class="row-fluid">
				...
				<div class="pagination pull-right">
					  <ul>
						<li class="active"><a class="ajaxify" href="ProductAction!productList?index=1">首页</a></li>
						<s:if test='(#request.currentIndex) > 1'> 
							<li class="active"><a class="ajaxify" href="ProductAction!productList?index=${requestScope.currentIndex-1}">上页</a></li>
						</s:if>
						<s:else>
						...
						<s:if test='(#request.currentIndex) < #pageCount'> 
							<li class="active"><a class="ajaxify" href="ProductAction!productList?index=${requestScope.currentIndex+1}">下页</a></li>
						</s:if>
						<s:else>
							<li class="disabled"><a href="javascript:;">下页</a></li>
						</s:else>
					 	<li class="active"><a class="ajaxify" href="ProductAction!productList?index=${pageCount }">末页</a></li>
					  </ul>
				</div>
			</div>
		</table>
