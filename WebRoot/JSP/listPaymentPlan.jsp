			...
			<div class="span6">
				<div class="control-group">
					<div class="controls">
						...
						<option value="clientName">按客户名称</option>
...
<div class="row-fluid">
	<form id="fom">
		<table>
			...
			<div class="row-fluid">
				<div class="row-fluid" style="text-align: center; font-size: 20px; background-color: #EEEEEE">收款计划列表</div>
					...
					<tbody>
						<s:iterator var="paymentPlan" value="#request.listObject">
							<tr>
								...
								<td><a class="ajaxify" href="PaymentPlanAction!edit?paymentPlan.id=${paymentPlan.id}&method=4">编辑(修改)</a> <a class="deleteOne" href="javascript:void(0)"
									data-action="PaymentPlanAction!deletePaymentPlan?delid=${paymentPlan.id }&method=8|${url}">删除</a></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
