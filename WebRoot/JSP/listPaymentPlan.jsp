		...
		<table>
			...
			<div class="row-fluid">
				...
				<table class="table table-striped">
					...
					<tbody>
						<s:iterator var="paymentPlan" value="#request.PaymentPlanList">
							<tr>
			...
			<div class="row-fluid">
				...
				<div class="pagination pull-right">
					  <ul>
						<li class="active"><a class="ajaxify" href="PaymentPlanAction!PaymentPlanList?index=1">首页</a></li>
						<s:if test='(#request.currentIndex) > 1'> 
							<li class="active"><a class="ajaxify" href="PaymentPlanAction!PaymentPlanList?index=${requestScope.currentIndex-1}">上页</a></li>
						</s:if>
						<s:else>
						...
						<s:if test='(#request.currentIndex) < #pageCount'> 
							<li class="active"><a class="ajaxify" href="PaymentPlanAction!PaymentPlanList?index=${requestScope.currentIndex+1}">下页</a></li>
						</s:if>
						<s:else>
